...
def unveilr_unpacket(mon_folder='', son_folder='', File_Config=None):
    ...
    New_Applet_Packet_Save_Folder = os.path.join(current_path, File_Config['Applet_Packet_Save_Path'], f"{app_config['window']['navigationBarTitleText']}_{wx_secret}_{time.strftime('%Y%m%d%H%M%S')}")
